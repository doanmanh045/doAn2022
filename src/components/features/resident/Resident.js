...
export default function Resident({ roomName, handleRoomName }) {
    ...
    return <>
        <div className={style.detail}>
                    <button className={style.btnAdd} onClick={handleShow}>Thêm</button>
                {/*  {apartmentId && <button onClick={() => setShow(true)}>Thêm</button>}
                ...
                <div className={style.wrapSearch}>
                    ...
                    <input
                        ...
                        value={name}
                        onChange={e => setName(e.target.value)}className={style.ipSearch}
                        />
                    <h6 >Số phòng</h6>
                        <input
                        
                        value={roomName}
                        onChange={e => handleRoomName(e.target.value)}className={style.ipSearch}
                        />
                    <h6 >Số điện thoại</h6>
                        <input
