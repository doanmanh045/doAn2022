                ...
                <Modal.Body>
                    ...
                    <ul className="menu">
                        ...
                        <li className="menu__item">
                            ...
                            <div className="menu__item--input">
                                <Controller
                                    ...
                                    rules={{ required: true, maxLength: 100 }}
                                />
                                <div className="menu__item--error--Small"> {errors.email && <small>Trường này không được để trống</small>}</div>
                            </div>
                        ...
                        <li className="menu__item">
                            ...
                            <div className="menu__item--error--Small"> {errors.position && <small>Trường này không được để trống</small>}</div>
